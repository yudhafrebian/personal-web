      ...
      <div className="w-3/5">
        ...
        <div className="flex items-center gap-12">
          ...
          <div className="flex gap-6">
            <a href="https://github.com/yudhafrebian" target="blank">
              <RiGithubFill
            ...
            <a href="https://www.linkedin.com/in/ananda-yudha-382533190/" target="blank">
              <RiLinkedinBoxFill
                className="hover:scale-125 duration-200 ease-out"
                color="white"
                size={36}
            ...
            <a href="https://www.instagram.com/yudha_frebian/" target="blank">
              <RiInstagramFill
                className="hover:scale-125 duration-200 ease-out"
                color="white"
                size={36}
            ...
            <a href="https://wa.me/6289637663755" target="blank">
              <RiWhatsappFill
                className="hover:scale-125 duration-200 ease-out"
                color="white"
                size={36}
